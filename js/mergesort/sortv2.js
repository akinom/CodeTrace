...
MergeSortV2.name = "MergeSort Improved";

MergeSortV2.code = ["def mergesort(lst, i, n):",
"    if (n <= 1):",
"      return",
"    if n <= 2:",
"       if lst[i] > lst[i+1]:",
...
var nSort = 0; 
var R7 = nSort; 
MergeSortV2[R7] = { name: "7 Numbers", nLst : 7, maxVal : 15.5 }; 
MergeSortV2[R7].lst = [8, 4, 3, 15, 6, 12, 1];

nSort++; 
var R25 = nSort;
MergeSortV2[R25] = { name: "25 Numbers", nLst : 25, maxVal : 100 };
MergeSortV2[R25].lst = [15, 80, 7, 1, 55, 25, 23, 72, 9, 98, 47, 70, 12, 100, 91, 72, 96, 45, 20, 36, 70, 94, 37, 25, 53];

nSort++; 
var R50 = nSort;
MergeSortV2[R50] = { name: "50 Numbers", nLst : 50, maxVal : 100 };
MergeSortV2[R50].lst = [51, 66, 69, 33, 8, 95, 1, 96, 100, 22, 29, 4, 72, 21, 100, 71, 19, 55, 70, 86, 10, 91, 74, 28, 12, 57, 36, 95, 48, 63, 23, 53, 78, 94, 100, 52, 41, 92, 86, 64, 91, 90, 16, 85, 6, 70, 38, 72, 78, 75];


MergeSortV2[R7].steps = [
{ action: 'curline', line: 0, text:'mergesort(lst, i=0, n=7)' },
{ action: 'setRange', i:0, n:7 },
{ action: 'step' },
{ action: 'curline', line: 1, text:'   if 7 <= 1'},
{ action: 'step' },
{ action: 'curline', line: 3, text:'   if 7 <= 2'},
{ action: 'step' },
{ action: 'curline', line:7, text: '   halflen = 3'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 0, 3)' },
{ action: 'step' },
...
{ action: 'step' },
{ action: 'curline', line: 3, text:'   if 3 <= 2'},
{ action: 'step' },
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 0, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 1, 2)' },
{ action: 'step' },
...
{ action: 'step' },
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[1] > lst[1+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(1,1+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
{ action: 'setSortedSlice',  i:1, n:2, array: [3, 4] },
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=0, middle=1, len=3)' },
{ action: 'step' },
{ action: 'setSortedSlice',  i:0, n:3, array: [3, 4, 8] },
{ action: 'step' },
{ action: 'curline',  line: 11, text : '   return'},
{ action: 'step' },
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 3, 4)' },
{ action: 'step' },
...
{ action: 'step' },
{ action: 'curline', line: 3, text:'   if 4 <= 2'},
{ action: 'step' },
{ action: 'curline', line:7, text: '   halflen = 2'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 3, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[3] > lst[3+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(3,3+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 5, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[5] > lst[5+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(5,5+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=3, middle=5, len=4)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=0, middle=3, len=7)' },
{ action: 'step' },
...
MergeSortV2[R25].steps = [
{ action: 'curline', line: 0, text:'mergesort(lst, i=0, n=25)' },
{ action: 'setRange', i:0, n:25 },
{ action: 'step' },
{ action: 'curline', line: 1, text:'   if 25 <= 1'},
{ action: 'step' },
{ action: 'curline', line: 3, text:'   if 25 <= 2'},
{ action: 'step' },
{ action: 'curline', line:7, text: '   halflen = 12'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 0, 12)' },
{ action: 'step' },
...
{ action: 'step' },
{ action: 'curline', line: 3, text:'   if 12 <= 2'},
{ action: 'step' },
{ action: 'curline', line:7, text: '   halflen = 6'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 0, 6)' },
{ action: 'step' },
...
{ action: 'step' },
{ action: 'curline', line: 3, text:'   if 6 <= 2'},
{ action: 'step' },
{ action: 'curline', line:7, text: '   halflen = 3'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 0, 3)' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 3, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 3, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 4, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[4] > lst[4+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(4,4+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=3, middle=4, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=0, middle=3, len=6)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 6, 6)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 3'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 6, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 6, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 7, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[7] > lst[7+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(7,7+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=6, middle=7, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 9, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 9, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 10, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[10] > lst[10+1]'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=9, middle=10, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=6, middle=9, len=6)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=0, middle=6, len=12)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 12, 13)' },
{ action: 'step' },
...
{ action: 'step' },
{ action: 'curline', line: 3, text:'   if 13 <= 2'},
{ action: 'step' },
{ action: 'curline', line:7, text: '   halflen = 6'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 12, 6)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 3'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 12, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 12, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 13, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[13] > lst[13+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(13,13+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=12, middle=13, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 15, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 15, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 16, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[16] > lst[16+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(16,16+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=15, middle=16, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=12, middle=15, len=6)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 18, 7)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 3'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 18, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 18, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 19, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[19] > lst[19+1]'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=18, middle=19, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 21, 4)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 2'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 21, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[21] > lst[21+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(21,21+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 23, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[23] > lst[23+1]'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=21, middle=23, len=4)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=18, middle=21, len=7)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=12, middle=18, len=13)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=0, middle=12, len=25)' },
{ action: 'step' },
...
MergeSortV2[R50].steps = [
{ action: 'curline', line: 0, text:'mergesort(lst, i=0, n=50)' },
{ action: 'setRange', i:0, n:50 },
{ action: 'step' },
{ action: 'curline', line: 1, text:'   if 50 <= 1'},
{ action: 'step' },
{ action: 'curline', line: 3, text:'   if 50 <= 2'},
{ action: 'step' },
{ action: 'curline', line:7, text: '   halflen = 25'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 0, 25)' },
{ action: 'step' },
...
{ action: 'curline', line: 4, text:'      if lst[10] > lst[10+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(10,10+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'curline', line: 4, text:'      if lst[19] > lst[19+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(19,19+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'curline', line: 4, text:'      if lst[23] > lst[23+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(23,23+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 25, 25)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 12'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 25, 12)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 6'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 25, 6)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 3'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 25, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 25, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 26, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[26] > lst[26+1]'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=25, middle=26, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 28, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 28, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 29, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[29] > lst[29+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(29,29+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=28, middle=29, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=25, middle=28, len=6)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 31, 6)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 3'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 31, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 31, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 32, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[32] > lst[32+1]'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=31, middle=32, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 34, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 34, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 35, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[35] > lst[35+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(35,35+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=34, middle=35, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=31, middle=34, len=6)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=25, middle=31, len=12)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 37, 13)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 6'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 37, 6)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 3'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 37, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 37, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 38, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[38] > lst[38+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(38,38+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=37, middle=38, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 40, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 40, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 41, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[41] > lst[41+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(41,41+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=40, middle=41, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=37, middle=40, len=6)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 43, 7)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 3'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 43, 3)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 1'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 43, 1)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 44, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[44] > lst[44+1]'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=43, middle=44, len=3)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 46, 4)' },
{ action: 'step' },
...
{ action: 'curline', line:7, text: '   halflen = 2'},
{ action: 'step' },
{ action: 'curline', line: 8, text:'   mergesort(lst, 46, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[46] > lst[46+1]'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 9, text:'   mergesort(lst, 48, 2)' },
{ action: 'step' },
...
{ action: 'curline', line: 3, text:'   if 2 <= 2'},
{ action: 'step' },
{ action: 'curline', line: 4, text:'      if lst[48] > lst[48+1]'},
{ action: 'step' },
{ action: 'curline', line: 5, text:'           swap(48,48+1)'},
{ action: 'step' },
{ action: 'curline', line: 6, text: '      return'},
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=46, middle=48, len=4)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=43, middle=46, len=7)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=37, middle=43, len=13)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=25, middle=37, len=25)' },
{ action: 'step' },
...
{ action: 'pop' },
{ action: 'step' },
{ action: 'curline', line: 10, text :'   merge(lst, left=0, middle=25, len=50)' },
{ action: 'step' },
